...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useHead({
      title: "Features - WishWeaver",
      meta: [
        {
          name: "description",
          content: "Discover WishWeaver features for creating group cards."
        }
      ]
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_PageTitle, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Features - WishWeaver`);
          } else {
            return [
              createTextVNode("Features - WishWeaver")
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=features-bpJUPCLA.mjs.map
