...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useHead({
      title: "How it works - WishWeaver",
      meta: [
        {
          name: "description",
          content: "Learn how WishWeaver works to create group cards."
        }
      ]
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_PageTitle, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`How it works - WishWeaver`);
          } else {
            return [
              createTextVNode("How it works - WishWeaver")
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=how-it-works-BOLm8XEb.mjs.map
