...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useHead({
      title: "Pricing - WishWeaver",
      meta: [{ name: "description", content: "View WishWeaver pricing plans." }]
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_PageTitle, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Pricing - WishWeaver`);
          } else {
            return [
              createTextVNode("Pricing - WishWeaver")
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=pricing-BXC9x8lS.mjs.map
