...
const unhead_hKAZA1_bvxiy93I1IP_9S2yD27tZYql1oogBkvMEW9k = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CxDFmX9O.mjs')
  },
  {
    name: "pricing",
    path: "/pricing",
    component: () => import('./pricing-BXC9x8lS.mjs')
  },
  {
    name: "features",
    path: "/features",
    component: () => import('./features-bpJUPCLA.mjs')
  },
  {
    name: "how-it-works",
    path: "/how-it-works",
    component: () => import('./how-it-works-BOLm8XEb.mjs')
  },
  {
    name: "testimonials",
    path: "/testimonials",
    component: () => import('./testimonials-CCdRRjH6.mjs')
  }
];
...
const revive_payload_server_EvxXt7eljGnTvrbkR87ZUijh5wN4ijnY1lzrPV_TQdI = /* @__PURE__ */ defineNuxtPlugin({
...
const LazyIcon = defineAsyncComponent(() => import('./index--3bApIOW.mjs').then((r) => r["default"] || r.default || r));
...
const plugin_H5sGgDAlZSyH4IKcZOuBfFOTH_kN1Ti70itniUgSSwQ = /* @__PURE__ */ defineNuxtPlugin({
  name: "@nuxt/icon",
  setup() {
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@4.1.2_@parcel+watcher@2.5.1_@vue+compiler-sfc@3.5.21_db0@0.3.2_eslint@9.36.0_jiti@_3cb32bb7578440ee5c03327eee55e661/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@4.1.2_@parcel+watcher@2.5.1_@vue+compiler-sfc@3.5.21_db0@0.3.2_eslint@9.36.0_jiti@_3cb32bb7578440ee5c03327eee55e661/node_modules/nuxt/dist/app/components/nuxt-root.vue");
